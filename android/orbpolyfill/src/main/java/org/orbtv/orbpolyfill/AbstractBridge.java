...
public abstract class AbstractBridge {
   ...
   */
     ...
     */
    protected abstract List<String> Configuration_getBroadcastCapabilities(BridgeToken token, int decoderIndex);
    ...
    public JSONObject request(String method, BridgeToken token, JSONObject params) throws JSONException {
        ...
        switch (method) {
            ...
            case "Configuration.getBroadcastCapabilities": {
                List<String> result = Configuration_getBroadcastCapabilities(
                        token,
                        params.getInt("decoderIndex")
                );
                if (result == null) {

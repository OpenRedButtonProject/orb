...
#include "aidl/org/orbtv/orbservice/IOrbcSession.h"
#include "aidl/org/orbtv/orbservice/IDvbiSession.h"
...
Java_org_orbtv_mock204app_MainActivity_nativeServiceConnected(
        JNIEnv* env,
        jobject /* this */,
        jobject binder)
{
...
extern "C" JNIEXPORT void JNICALL
Java_org_orbtv_mock204app_MainActivity_nativeServiceDisconnected(
        JNIEnv* env,
        jobject /* this */)
{
...
extern "C" JNIEXPORT void JNICALL
Java_org_orbtv_mock204app_MainActivity_nativeTest(
        JNIEnv* env,
        jobject /* this */)
{

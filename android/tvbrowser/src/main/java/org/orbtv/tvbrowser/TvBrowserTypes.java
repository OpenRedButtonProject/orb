   ...
   public static class Query {
         ...
         try {
            ...
            if (in.has("operation")) {
               switch (in.getString("operation")) {
                  case "IDENTITY": mOperation = OP_ID;
                     break;
                  case "AND": mOperation = OP_AND;
                     break;
                  case "OR": mOperation = OP_OR;
                     break;
                  case "NOT": mOperation = OP_NOT;
                     break;
               }
      ...
      private String getCompareString()
      {
         switch (mComparison) {
            ...
            case CMP_NOT_EQL: { return " != "; }
            case CMP_MORE: { return " > "; }
            case CMP_MORE_EQL: { return " >= "; }
            case CMP_LESS: { return " < "; }
            case CMP_LESS_EQL: { return " <= "; }
            case CMP_CONTAINS: { return " Ct "; }
         }
         return "";
      }
   }

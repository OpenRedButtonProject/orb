...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniInitialize(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniFinalize(JNIEnv *env, jobject object)
{
   delete GetManager(env, object);
}

extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniCreateApplication(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniDestroyApplication(JNIEnv *env, jobject object,
   jint calling_app_id)
{
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniShowApplication(JNIEnv *env, jobject object,
   jint calling_app_id)
{
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniHideApplication(JNIEnv *env, jobject object,
   jint calling_app_id)
{
...
extern "C"
JNIEXPORT jint JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniGetKeySetMask(JNIEnv *env, jobject object,
   jint calling_app_id)
{
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniProcessAitSection(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniProcessXmlAit(JNIEnv *env, jobject object,
   jstring j_data)
{
...
extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniIsTeletextApplicationSignalled(JNIEnv *env, jobject object)
{
   return GetManager(env, object)->IsTeletextApplicationSignalled();
}

extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniRunTeletextApplication(JNIEnv *env, jobject object)
{
   return GetManager(env, object)->RunTeletextApplication();
}

extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniOnNetworkAvailabilityChanged(JNIEnv *env, jobject object,
   jboolean available)
{
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniOnLoadApplicationFailed(JNIEnv *env, jobject object,
   jint app_id)
{
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniOnApplicationPageChanged(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniOnChannelChange(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniOnBroadcastStopped(JNIEnv *env, jobject object)
{
   GetManager(env, object)->OnBroadcastStopped();
}

extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_tvbrowser_ApplicationManager_jniIsRequestAllowed(JNIEnv *env, jobject object,

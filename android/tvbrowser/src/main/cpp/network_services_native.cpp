...
public:
        ...
        unitsPerSecond) override
    {
        ...
        env->CallVoidMethod(mJavaCbObject, gCb[CB_DISPATCH_TIMELINE_AVAILABLE_EVENT], j_timeline,
            unitsPerSecond);
    ...
    {
        JNIEnv *env = JniUtils::GetEnv();
        env->CallVoidMethod(mJavaCbObject, gCb[CB_DISPATCH_INTER_DEVICE_SYNC_DISABLED],
            mediaSyncId);
    }
    ...
    {
        JNIEnv *env = JniUtils::GetEnv();
        return env->CallIntMethod(mJavaCbObject, gCb[CB_START_TIMELINE_MONITORING], componentTag,
            timelineId);
    }
    ...
    {
        JNIEnv *env = JniUtils::GetEnv();
        return env->CallBooleanMethod(mJavaCbObject, gCb[CB_STOP_TIMELINE_MONITORING], filterId,
            false);
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniInitialise(JNIEnv *env,
    jobject thiz,
...
extern "C"
JNIEXPORT jint JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniCreateMediaSynchroniser(
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniInitialiseMediaSynchroniser(
    JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void
JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniDestroyMediaSynchroniser(JNIEnv *env,
    jobject thiz,
    jint id)
{
    NetworkServices::MediaSynchroniserManager *ms = GetMediaSyncManagerHandle(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniDisableInterDeviceSync(
    JNIEnv *env,
    jobject thiz)
{
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniEnableInterDeviceSync(JNIEnv *env,
    jobject thiz,
    jstring ipAddr)
{
    NetworkServices::MediaSynchroniser *ms = GetActiveMediaSyncHandle(env, thiz);
...
extern "C"
JNIEXPORT jint JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniNrOfSlaves(JNIEnv *env,
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniInterDeviceSyncEnabled(JNIEnv *env,
    jobject thiz, jint id)
{
    NetworkServices::MediaSynchroniser *ms = GetMediaSyncHandleById(env, thiz, id);
    if (ms != nullptr)
...
extern "C"
JNIEXPORT jstring JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniGetContentIdOverride(
    JNIEnv *env,
    jobject thiz, jint id)
{
    NetworkServices::MediaSynchroniser *ms = GetMediaSyncHandleById(env, thiz, id);
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniSetContentIdOverride(
    JNIEnv *env,
    jobject thiz,
    jint id,
    jstring cid)
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniUpdateDvbInfo(
    JNIEnv *env,
    jobject thiz,
    jstring dvbUri,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniUpdateCssCiiProperties(
    JNIEnv *env,
    jobject thiz,
    jstring contentId,
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniStartTimelineMonitoring(JNIEnv *env,
    jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniStopTimelineMonitoring(
    JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniSetContentTimeAndSpeed(JNIEnv *env,
    jobject thiz,
    jstring timelineSelector,
    jlong content_time,
    jdouble speed)
...
extern "C"
JNIEXPORT jlong JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniGetContentTime(
    JNIEnv *env,
    jobject thiz,
    jstring timelineSelector)
{
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniSetTEMITimelineAvailability(
    JNIEnv *env, jobject thiz,
    jint filterId,
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniSetTimelineAvailability(JNIEnv *env,
    jobject thiz,
    jint id,
    jstring timelineSelector,
    jboolean isAvailable,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_tvbrowser_MediaSynchroniserManager_jniReleaseResources(
    JNIEnv *env, jobject thiz)
{
    NetworkServices::MediaSynchroniserManager *ms = GetMediaSyncManagerHandle(env, thiz);
    if (ms != nullptr)

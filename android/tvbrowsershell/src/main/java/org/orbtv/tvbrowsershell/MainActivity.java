...
public class MainActivity extends Activity {
    ...
    private static final String USER_AGENT = "HbbTV/1.6.1 (; OBS; Android; v1.0.0-alpha; OBS;)";
    ...
    private TvBrowser.Session mTvBrowserSession = null;
    private MockTvBrowserCallback mMockCallback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TvBrowser.Configuration configuration = new TvBrowser.Configuration(
                MEDIA_SYNC_WC_PORT,
                MEDIA_SYNC_CII_PORT,
                MEDIA_SYNC_TS_PORT,
                APP2APP_LOCAL_PORT,

...
public:
   ...
   {
      JNIEnv *env = JniUtils::GetEnv();
      auto j_region = static_cast<jstring>(env->CallObjectMethod(mJavaCbObject, gCb[CB_GET_PARENTAL_CONTROL_REGION]));
   ...
   {
      JNIEnv *env = JniUtils::GetEnv();
      auto j_region = static_cast<jstring>(env->CallObjectMethod(mJavaCbObject, gCb[CB_GET_PARENTAL_CONTROL_REGION3]));
      std::string region = JniUtils::MakeStdString(env, j_region);
      env->DeleteLocalRef(j_region);
      return region;
   }
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniInitialize(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniFinalize(JNIEnv *env, jobject object)
{
   delete GetManager(env, object);
}

extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniCreateApplication(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniDestroyApplication(JNIEnv *env, jobject object,
   jint calling_app_id)
{
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniShowApplication(JNIEnv *env, jobject object,
   jint calling_app_id)
{
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniHideApplication(JNIEnv *env, jobject object,
   jint calling_app_id)
{
...
extern "C"
JNIEXPORT jint JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniSetKeySetMask(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT jint JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniGetKeySetMask(JNIEnv *env, jobject object,
   jint calling_app_id)
{
...
extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniInKeySet(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniProcessAitSection(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniProcessXmlAit(JNIEnv *env, jobject object,
   jstring j_data)
{
...
extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniIsTeletextApplicationSignalled(JNIEnv *env, jobject object)
{
   return GetManager(env, object)->IsTeletextApplicationSignalled();
}

extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniRunTeletextApplication(JNIEnv *env, jobject object)
{
   return GetManager(env, object)->RunTeletextApplication();
}

extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniOnNetworkAvailabilityChanged(JNIEnv *env, jobject object,
   jboolean available)
{
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniOnLoadApplicationFailed(JNIEnv *env, jobject object,
   jint app_id)
{
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniOnApplicationPageChanged(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniOnChannelChange(JNIEnv *env, jobject object,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniOnBroadcastStopped(JNIEnv *env, jobject object)
{
   GetManager(env, object)->OnBroadcastStopped();
}

extern "C"
JNIEXPORT jboolean JNICALL Java_org_orbtv_orblibrary_ApplicationManager_jniIsRequestAllowed(JNIEnv *env, jobject object,
...
static ApplicationManager* GetManager(JNIEnv *env, jobject object)
{
   return reinterpret_cast<ApplicationManager *>(env->GetLongField(object, gJavaManagerPointerField));
}

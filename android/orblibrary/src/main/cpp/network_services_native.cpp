...
public:
    ...
    void dispatchTimelineAvailableEvent(std::string timelineSelector, u_int64_t
        unitsPerSecond) override
    {
        JNIEnv *env = JniUtils::GetEnv();
        jstring j_timeline = env->NewStringUTF(timelineSelector.c_str());
        env->CallVoidMethod(mJavaCbObject, g_cb[CB_DISPATCH_TIMELINE_AVAILABLE_EVENT], j_timeline,
            unitsPerSecond);
    ...
    void dispatchTimelineUnavailableEvent(std::string timelineSelector) override
    {
        JNIEnv *env = JniUtils::GetEnv();
        jstring j_timeline = env->NewStringUTF(timelineSelector.c_str());
        env->CallVoidMethod(mJavaCbObject, g_cb[CB_DISPATCH_TIMELINE_UNAVAILABLE_EVENT],
            j_timeline);
        env->DeleteLocalRef(j_timeline);
    }
    ...
    {
        JNIEnv *env = JniUtils::GetEnv();
        env->CallVoidMethod(mJavaCbObject, g_cb[CB_DISPATCH_INTER_DEVICE_SYNC_ENABLED],
            mediaSyncId);
    }
    ...
    {
        JNIEnv *env = JniUtils::GetEnv();
        env->CallVoidMethod(mJavaCbObject, g_cb[CB_DISPATCH_INTER_DEVICE_SYNC_DISABLED],
            mediaSyncId);
    }
    ...
    {
        JNIEnv *env = JniUtils::GetEnv();
        return env->CallIntMethod(mJavaCbObject, g_cb[CB_START_TIMELINE_MONITORING], componentTag,
            timelineId);
    }
    ...
    {
        JNIEnv *env = JniUtils::GetEnv();
        return env->CallBooleanMethod(mJavaCbObject, g_cb[CB_STOP_TIMELINE_MONITORING], filterId,
            false);
    }
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniInitialise(JNIEnv *env,
    jobject thiz,
    jint ciiPort, jint wcPort, jint tsPort)
{
    auto timelineSyncCallback = std::make_shared<AndroidMediaSyncCallback>(thiz);
    auto *ms = new NetworkServices::MediaSynchroniserManager(std::move(timelineSyncCallback),
        ciiPort, wcPort, tsPort);
    env->SetLongField(thiz, g_java_manager_field_id, jlong(ms));
}

extern "C"
JNIEXPORT jint
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniCreateMediaSynchroniser(JNIEnv *env,
    jobject thiz)
{
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniInitialiseMediaSynchroniser(
...
extern "C"
JNIEXPORT void
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniDestroyMediaSynchroniser(JNIEnv *env,
    jobject thiz,
    jint id)
{
    NetworkServices::MediaSynchroniserManager *ms = GetMediaSyncManagerHandle(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniDisableInterDeviceSync(
    JNIEnv *env,
    jobject thiz)
{
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniEnableInterDeviceSync(JNIEnv *env,
    jobject thiz,
    jstring ipAddr)
{
    NetworkServices::MediaSynchroniser *ms = GetActiveMediaSyncHandle(env, thiz);
...
extern "C"
JNIEXPORT jint JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniNrOfSlaves(JNIEnv *env,
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniInterDeviceSyncEnabled(JNIEnv *env,
    jobject thiz, jint id)
{
    NetworkServices::MediaSynchroniser *ms = GetMediaSyncHandleById(env, thiz, id);
    if (ms != nullptr)
...
extern "C"
JNIEXPORT jstring
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniGetContentIdOverride(JNIEnv *env,
    jobject thiz, jint id)
{
    NetworkServices::MediaSynchroniser *ms = GetMediaSyncHandleById(env, thiz, id);
    if (ms != nullptr)
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniSetContentIdOverride(
    JNIEnv *env,
    jobject thiz,
    jint id,
    jstring cid)
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniUpdateCssCiiProperties(
    JNIEnv *env,
    jobject thiz,
    jstring contentId,
    ...
    jstring mrsUrl)
{
    ...
    if (ms != nullptr)
    {
        ...
        const char *nativeStringPresentationStatus = env->GetStringUTFChars(presentationStatus,
            &isCopyPresentationStatus);
        const char *nativeStringContentIdStatus = env->GetStringUTFChars(contentIdStatus,
            &isCopyContentIdStatus);
        const char *nativeStringCopyMrsUrl = env->GetStringUTFChars(mrsUrl, &isCopyMrsUrl);

        ms->updateCssCiiProperties(nativeStringContentId, nativeStringPresentationStatus,
            nativeStringContentIdStatus, nativeStringCopyMrsUrl);
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniStartTimelineMonitoring(JNIEnv *env,
    jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniStopTimelineMonitoring(
    JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniSetContentTimeAndSpeed(JNIEnv *env,
    jobject thiz,
    jstring timelineSelector,
    jlong content_time,
    jdouble speed)
...
extern "C"
JNIEXPORT jlong JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniGetContentTime(
    JNIEnv *env,
    jobject thiz,
    jstring timelineSelector)
{
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniSetTEMITimelineAvailability(
    JNIEnv *env, jobject thiz,
    jint filterId,
    ...
    jdouble speed)
{
    ...
    if (ms != nullptr)
    {
        result = ms->setTEMITimelineAvailability(filterId, isAvailable, currentTime, timescale,
            speed);
    }
    return result;
}
...
extern "C"
JNIEXPORT jboolean
JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniSetTimelineAvailability(JNIEnv *env,
    jobject thiz,
    jint id,
    jstring timelineSelector,
    jboolean isAvailable,
...
extern "C"
JNIEXPORT void JNICALL Java_org_orbtv_orblibrary_MediaSynchroniserManager_jniReleaseResources(
    JNIEnv *env, jobject thiz)
{
    NetworkServices::MediaSynchroniserManager *ms = GetMediaSyncManagerHandle(env, thiz);
    if (ms != nullptr)

...
import org.orbtv.orblibrary.IDsmccCallback;
import org.orbtv.orblibrary.IDsmcc;
...
public class MockDsmcc implements IDsmcc {
    private static final String TAG = "MockDsmcc";

    private final Context mContext;
    private String mBasePath;
    private String mDsmPath = "";
    private IDsmccCallback mDsmccClient;
     ...
     */
    public void setDsmccCallback(IDsmccCallback client) {
        mDsmccClient = client;
    }

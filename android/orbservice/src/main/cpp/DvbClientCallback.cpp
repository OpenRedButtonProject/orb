...
string DvbClientCallback::request(string jsonRequest)
{
    string response = "{\"error\": \"Not implemented\"}";

    return response;
}

void DvbClientCallback::getDvbContent(string url, int requestId)
{
}

...
hbbtv.objects.OipfCapabilities = (function() {
   ...
   function getXmlCapabilities(p) {
      function createXmlCapabilities(capabilities) {
         ...
         doc.documentElement.setAttribute("xsi:schemaLocation", "urn:hbbtv:config:oitf:oitfCapabilities:2017-1 " +
      ...
      displaySizeElement.setAttribute("measurement_type", capabilities.displaySizeMeasurementType);
      ...
      if (typeof capabilities.html5MediaVariableRateMin === "string" &&
   ...
   function initialise() {
      ...
      sysIds.forEach(element => p.drmSystemIdStatusMap.set(element.DRMSystemID, keepRelevantProps(element)));
   }

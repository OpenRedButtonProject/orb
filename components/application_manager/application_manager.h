...
public:
    ...
    */
   void ProcessAitSection(uint16_t ait_pid, uint16_t service_id, uint8_t *section_data, uint32_t section_data_bytes);
    ...
    * be killed depending on the signalling.
    */
   void OnChannelChanged(uint16_t original_network_id, uint16_t transport_stream_id, uint16_t service_id);

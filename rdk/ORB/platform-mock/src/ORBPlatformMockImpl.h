...
public:
   ...
   virtual int Broadcast_SetChannelToCcid(std::string ccid, bool trickplay, std::string contentAccessDescriptorURL, int quiet) override;
   virtual int Broadcast_SetChannelToNull() override;
   virtual int Broadcast_SetChannelToTriplet(int idType, int onid, int tsid, int sid, int sourceID, std::string ipBroadcastID, bool trickplay, std::string contentAccessDescriptorURL, int quiet) override;
   virtual int Broadcast_SetChannelToDsd(std::string dsd, int sid, bool trickplay, std::string contentAccessDescriptorURL, int quiet) override;
   ...
   virtual bool Configuration_RequestAccessToDistinctiveIdentifier(std::string origin, std::map<std::string, std::string> appNames) override;
   ...
   virtual std::string Drm_SendDrmMessage(std::string messageId, std::string messageType, std::string message, std::string drmSystemId, bool blocked) override;

...
public:
   ...
   /**
    * Enumerates the Channel error states.
    * (See OIPF DAE spec section 7.13.1.2 onChannelChangeError table)
    */
   enum ErrorState
   {
      CHANNEL_ERROR_STATE_NOT_SUPPORTED          = 0x00, // (decimal 000)
      CHANNEL_ERROR_STATE_NO_SIGNAL              = 0x01, // (decimal 001)
      CHANNEL_ERROR_STATE_TUNER_IN_USE           = 0x02, // (decimal 002)
      CHANNEL_ERROR_STATE_PARENTAL_LOCKED        = 0x03, // (decimal 003)
      CHANNEL_ERROR_STATE_ENCRYPTED              = 0x04, // (decimal 004)
      CHANNEL_ERROR_STATE_UNKNOWN_CHANNEL        = 0x05, // (decimal 005)
      CHANNEL_ERROR_STATE_INTERRUPTED            = 0x06, // (decimal 006)
      CHANNEL_ERROR_STATE_RECORDING_IN_PROGRESS  = 0x07, // (decimal 007)
      CHANNEL_ERROR_STATE_CANNOT_RESOLVE_URI     = 0x08, // (decimal 008)
      CHANNEL_ERROR_STATE_INSUFFICIENT_BANDWIDTH = 0x09, // (decimal 009)
      CHANNEL_ERROR_STATE_CANNOT_BE_CHANGED      = 0x0a, // (decimal 010)
      CHANNEL_ERROR_STATE_INSUFFICIENT_RESOURCES = 0x0b, // (decimal 011)
      CHANNEL_ERROR_STATE_CHANNEL_NOT_IN_TS      = 0x0c, // (decimal 012)
      CHANNEL_ERROR_STATE_UNKNOWN_ERROR          = 0x64  // (decimal 100)
   };

   /**
    * Enumerates the channel status codes.
    */
   enum Status
   {

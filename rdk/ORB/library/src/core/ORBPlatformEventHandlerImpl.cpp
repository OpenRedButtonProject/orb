...
void ORBPlatformEventHandlerImpl::OnChannelStatusChanged(int onetId, int transId, int servId, int statusCode, bool permanentError)
{
   ...
   ORB_LOG("Ready to call ORBEngine OnJavaScriptEventDispatchRequested");
 ...
 */
void ORBPlatformEventHandlerImpl::OnDvbUrlLoaded(int requestId, const uint8_t *fileContent, unsigned int fileContentLength)
{

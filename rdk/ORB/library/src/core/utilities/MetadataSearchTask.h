...
public:
     ...
     */
    MetadataSearchTask(std::shared_ptr<Query> query, int offset, int count,
...
private:
     ...
     */
    bool CompareStringValues(Query::Comparison comparison, std::string programmeValue, std::string
        queryValue);

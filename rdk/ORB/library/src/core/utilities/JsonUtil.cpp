...
json JsonUtil::CapabilitiesToJsonObject(std::shared_ptr<Capabilities> capabilities)
{
   ...
   jsonCapabilities.emplace("displaySizeMeasurementType", capabilities->m_displaySizeMeasurementType);
   ...
   {
      jsonCapabilities.emplace("html5MediaVariableRateMin", capabilities->m_html5MediaVariableRateMin);
   }

   if (!capabilities->m_html5MediaVariableRateMax.empty())
   {
      jsonCapabilities.emplace("html5MediaVariableRateMax", capabilities->m_html5MediaVariableRateMax);
   }

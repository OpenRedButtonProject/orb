...
{
    JSONRPC::Register<JsonObject, JsonObject>(_T("ExecuteWpeBridgeRequest"),
        &ORB::ExecuteWpeBridgeRequest, this);
    JSONRPC::Register<Core::JSON::String, JsonObject>(_T("CreateToken"), &ORB::CreateToken, this);
    JSONRPC::Register<ApplicationLoadFailedParamsData, void>(_T("ApplicationLoadFailed"),
        &ORB::ApplicationLoadFailed, this);
    JSONRPC::Register<Core::JSON::String, void>(_T("ApplicationPageChanged"),
        &ORB::ApplicationPageChanged, this);
    JSONRPC::Register<LoadDvbUrlParamsData, void>(_T("LoadDvbUrl"), &ORB::LoadDvbUrl, this);
    JSONRPC::Register<Core::JSON::DecUInt16, Core::JSON::Boolean>(_T("SendKeyEvent"),
...
uint32_t ORB::ExecuteWpeBridgeRequest(JsonObject request, JsonObject& response)
{
    ...
    SYSLOG(Logging::Notification, (_T("[ORB::ExecuteWpeBridgeRequest] request=%s"),
                                   requestAsString.c_str()));
    ...
    SYSLOG(Logging::Notification, (_T("[ORB::ExecuteWpeBridgeRequest] object=%s method=%s"),
    ...
    SYSLOG(Logging::Notification, (_T("[ORB::ExecuteWpeBridgeRequest] response=%s"),
...
{
    SYSLOG(Logging::Notification, (_T("[ORB::CreateToken] uri=%s appId=%hu"), uri.Value().c_str(),
                                   _currentAppId));
...
{
    SYSLOG(Logging::Notification, (_T("[ORB::ApplicationPageChanged] appId=%d url=%s"),
                                   _currentAppId, url.Value().c_str()));

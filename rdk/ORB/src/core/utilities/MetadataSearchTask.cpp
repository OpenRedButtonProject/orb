    ...
    std::vector<std::string> searchResults)
{
    ...
    ORB::instance(nullptr)->NotifyJavaScriptEventDispatchRequested("MetadataSearch", properties,
        true, "");
}
...
uint32_t MetadataSearchTask::Worker()
{
    ...
    {
        fprintf(stderr,
            "[MetadataSearchTask::Worker] ERROR: ORB platform implementation not available\n");
        return infinite;
    }

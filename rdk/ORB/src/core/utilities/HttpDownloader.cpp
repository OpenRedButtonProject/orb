...
// HttpDownloader::DownloadedObject
...
{
  fprintf(stderr, "[HttpDownloader::Download] url=%s\n", url.c_str());
  ...
  if (res != CURLE_OK || ct == NULL) {
    fprintf(stderr, "[HttpDownloader::Download] Could not resolve content type of downloaded object\n");
    return downloadedObject;
  }
  fprintf(stderr, "[HttpDownloader::Download] content type of downloaded object is: %s\n", ct);
  contentType = ct;

...
public:
    ...
    virtual bool Broadcast_SetChannel(std::shared_ptr<Channel> channel, bool trickplay, std::string
        contentAccessDescriptorURL, bool quiet, int *channelChangeError) override;

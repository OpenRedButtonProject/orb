...
{
    Property<Core::JSON::EnumType<StateType> >(_T("state"), &ORBBrowser::get_state,
        &ORBBrowser::set_state, this);                                                                                /* StateControl */
    Property<Core::JSON::ArrayType<Core::JSON::String> >(_T("languages"),
        &ORBBrowser::get_languages, &ORBBrowser::set_languages, this);
    Property<Core::JSON::ArrayType<JsonData::WebKitBrowser::HeadersData> >(_T("headers"),
        &ORBBrowser::get_headers, &ORBBrowser::set_headers, this);
...
// Return codes:
//  - ERROR_NONE: Success
uint32_t ORBBrowser::get_headers(
    Core::JSON::ArrayType<JsonData::WebKitBrowser::HeadersData>& response) const
{
...
// Return codes:
//  - ERROR_NONE: Success
uint32_t ORBBrowser::set_headers(const
    Core::JSON::ArrayType<JsonData::WebKitBrowser::HeadersData>& param)
{
    ASSERT(_browser != nullptr);
...
uint32_t ORBBrowser::get_state(Core::JSON::EnumType<StateType>& response) const     /* StateControl */
{
    ...
    if (stateControl != nullptr)
    {
        ...
        response = (currentState == PluginHost::IStateControl::SUSPENDED ? StateType::SUSPENDED :
                    StateType::RESUMED);
...
uint32_t ORBBrowser::set_state(const Core::JSON::EnumType<StateType>& param)     /* StateControl */
{
    ...
    if (param.IsSet())
    {
        ...
        if (stateControl != nullptr)
        {
            stateControl->Request(param == StateType::SUSPENDED ?
                PluginHost::IStateControl::SUSPEND : PluginHost::IStateControl::RESUME);

...
namespace Plugin {
class ORBBrowser : public PluginHost::IPlugin, public PluginHost::IWeb, public PluginHost::JSONRPC {
private:
    ORBBrowser(const ORBBrowser&) = delete;
    ORBBrowser& operator=(const ORBBrowser&) = delete;
...
public:
        explicit Notification(ORBBrowser *parent)
            : _parent(*parent)
        {
...
public:
    BEGIN_INTERFACE_MAP(ORBBrowser)
...
private:
    ...
    Core::ProxyPoolType<Web::JSONBodyType<ORBBrowser::Data> > _jsonBodyDataFactory;

   ...
   if (_browser != nullptr)
   {
      ...
      else
      {
         ...
         if (_application != nullptr)
         {
            ...
            _memory = WPEFramework::ORBBrowser::StateAwareMemoryObserver::Wrap(WPEFramework::ORBBrowser::MemoryObserver(connection));
            ASSERT(_memory != nullptr);
...
/* virtual */ Core::ProxyType<Web::Response> ORBBrowser::Process(const Web::Request& request)
{
   ...
   if (_browser != nullptr)
   {
      ...
      if (request.Verb == Web::Request::HTTP_GET)
      {
         ...
         Core::ProxyType<Web::JSONBodyType<ORBBrowser::Data> > body(_jsonBodyDataFactory.Element());
         string url;

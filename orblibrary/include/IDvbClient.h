...
public:
    ...
    /**
     * Execute the given request from Orb.
     ...
     */
    virtual std::string request(std::string jsonRequest) = 0;

    /**
     * Get file content from DSM-CC
     * @param url DVB url for the file
     * @param requestId ID for this request
     */
    virtual void getDvbContent(std::string url, int requestId) = 0;
